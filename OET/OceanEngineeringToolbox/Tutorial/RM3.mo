...
model RM3
  ...
  Hydro.HydrodynamicBody spar(enableRadiationForce = false, enableDampingDragForce = false, ra_CM = {0, 0, -21.29}, enableHydrostaticForce = false, bodyIndex = 2, I_11 = 94419615, I_22 = 94407091, I_33 = 28542225, enableExcitationForce = true, animationEnable = false)  annotation(
  ...
  inner Environmental.Environment environment(waveSelector = "PiersonMoskowitz", frequencySelection = "equalEnergy")  annotation(
