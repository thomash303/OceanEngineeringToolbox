...
% waves.direction = [0, 0, 0, 0, 0, 30, 30, 30, 30, 30, 90, 90, 90, 90, 90];
% waves.spread    = [0.02, 0.02, 0.02, 0.02, 0.02, ...
%                    0.04, 0.04, 0.04, 0.04, 0.04, ...
%                    0.14, 0.14, 0.14, 0.14, 0.14];
waves.direction = [repmat(0, 1, 20), repmat(30, 1, 20), repmat(90, 1, 20)];
waves.spread    = [repmat(0.005, 1, 20), repmat(0.010, 1, 20), repmat(0.035, 1, 20)];
