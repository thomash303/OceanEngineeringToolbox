...
%% Loading data
load('cargo_data.mat');
load('oet_cargo_data_final_sign.mat');
...
figure('Name','Piston Cylinder Pressure and Force')
subplot(2,1,1)
plot(oet_cargo_data.time, oet_cargo_data.p1, 'DisplayName','P1 sim')
hold on
plot(oet_cargo_data.time, oet_cargo_data.p2, 'DisplayName','P2 sim')
...
subplot(2,1,2)
plot(oet_cargo_data.time, oet_cargo_data.fpto, 'DisplayName','Fpto sim')
hold on
...
plot(oet_cargo_data.time, oet_cargo_data.fpto, 'DisplayName','$F_{pto}$ sim', 'LineWidth', LineWidth)
hold on
...
plot(oet_cargo_data.time, oet_cargo_data.p1, 'DisplayName','$P1$ sim', 'LineWidth', LineWidth) 
hold on
plot(cargo_data.pressure(1).t, cargo_data.pressure(1).p, '--', 'DisplayName','$P1$ exp', 'LineWidth', LineWidth)
plot(oet_cargo_data.time, oet_cargo_data.p2, 'DisplayName','$P2$ sim', 'LineWidth', LineWidth)
