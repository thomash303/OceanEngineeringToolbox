...
model linearTranslationalPTO
  ...
  parameter SI.TranslationalSpringConstant Kpto = 0 "PTO stiffness coefficient";
  parameter SI.TranslationalDampingConstant Cpto = 0 "PTO damping coefficient";
  parameter Types.Axis n = {0, 0, 1} "Joint axis of translation resolved in frame_a (= same as in frame_b)";
  parameter SI.Position s_ref = 0 "Reference or equilibirum position (Unstretched spring length)";
  SI.Power P "PTO power output";
  
  Joints.Prismatic prismatic(useAxisFlange = true, animation = false, n = n) annotation(
