...
partial class massNoB2BData
  ...
  parameter SI.Mass M[1, 1] = readRealMatrix(file, "hydro.bodies.m" + bodyIndexString, 1, 1) "Total mass of the body";
protected
  parameter SI.Mass Ainf[bodyDoF, bodyDoF] = readRealMatrix(file, "hydro.coefficients.radiation.stateSpace.noB2B.Ainf" + bodyIndexString, bodyDoF, bodyDoF) "Added mass at maximum (cut-off) frequency";
