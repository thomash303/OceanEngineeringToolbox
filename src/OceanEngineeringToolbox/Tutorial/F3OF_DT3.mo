...
model F3OF_DT3 "Tutorial model for representing the F-3OF decay test 1 in the WEC3 comparison project"
  ...
  Multibody.Joints.Revolute revolute(phi(start = 0.17453292519943295, fixed = true), n = {0, 1, 0})  annotation(
    Placement(transformation(origin = {-30, -10}, extent = {{-10, -10}, {10, 10}})));
  Multibody.Joints.Revolute revolute1(n = {0, 1, 0})  annotation(
...
equation
  ...
  connect(world.frame_b, fixedTranslation.frame_a) annotation(
    Line(points = {{-66, -68}, {-40, -68}, {-40, -66}}, color = {95, 95, 95}));
  connect(fixedTranslation.frame_b, base.frame_c) annotation(
    Line(points = {{-20, -66}, {4, -66}, {4, -20}}, color = {95, 95, 95}));
  connect(base.frame_a, revolute.frame_b) annotation(
    Line(points = {{-6, -10}, {-20, -10}}, color = {95, 95, 95}));
  connect(revolute.frame_a, flap1.frame_b) annotation(
    Line(points = {{-40, -10}, {-40, 26}}, color = {95, 95, 95}));
  connect(base.frame_b, revolute1.frame_a) annotation(
    Line(points = {{14, -10}, {26, -10}}, color = {95, 95, 95}));
  connect(revolute1.frame_b, flap2.frame_a) annotation(
    Line(points = {{46, -10}, {46, 24}}, color = {95, 95, 95}));
  annotation(
