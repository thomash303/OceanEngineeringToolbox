...
model F3OF_DT1 "Tutorial model for representing the F-3OF decay test 1 in the WEC3 comparison project"
  ...
  inner DataImport.FileDirectory fileDirectory(file = "C:/Users/thogan1/Documents/GitHub/OceanEngineeringToolbox/applications/Validation/F3OF/F3OFhydroCoeff.mat") annotation(
  ...
  Multibody.Joints.FreeMotion freeMotion(r_rel_a(start = {5, 0, 0}, each fixed = true))  annotation(
    Placement(transformation(origin = {-28, -68}, extent = {{-10, -10}, {10, 10}})));
  Hydro.HydrodynamicBody base(enableExcitationForce = true, animationEnable = false, geometryFile = "file://C:/Users/thogan1/Documents/GitHub/OceanEngineeringToolbox/applications/Validation/F3OF/geometry/base.obj", bodyIndex = 1, enableRadiationForce = true, ra_CM = {-12.5, 0, 0}, rCM_b = {12.5, 0, 0}, redeclare Forces.RadiationB2B radiation(file = fileDirectory.file) "B2B Radiation Force") annotation(
    Placement(transformation(origin = {4, -10}, extent = {{-10, -10}, {10, 10}})));
  
  Hydro.HydrodynamicBody flap1(bodyIndex = 2, animationEnable = false, geometryFile = "file://C:/Users/thogan1/Documents/GitHub/OceanEngineeringToolbox/applications/Validation/F3OF/geometry/flap.obj", rCM_b = {0, 0, -3.5}, enableRadiationForce = true, redeclare Forces.RadiationB2B radiation(file = fileDirectory.file) "B2B Radiation Force")  annotation(
                              Placement(transformation(origin = {-46, 14}, extent = {{-10, -10}, {10, 10}})));
  Hydro.HydrodynamicBody flap2(bodyIndex = 3, animationEnable = false, geometryFile = "file://C:/Users/thogan1/Documents/GitHub/OceanEngineeringToolbox/applications/Validation/F3OF/geometry/flap.obj", ra_CM = {0, 0, 3.5}, enableRadiationForce = true, redeclare Forces.RadiationB2B radiation(file = fileDirectory.file) "B2B Radiation Force")  annotation(
...
equation
  connect(world.frame_b, freeMotion.frame_a) annotation(
    Line(points = {{-66, -68}, {-38, -68}}, color = {95, 95, 95}));
  connect(freeMotion.frame_b, fixedTranslation.frame_a) annotation(
    Line(points = {{-18, -68}, {4, -68}, {4, -66}}, color = {95, 95, 95}));
