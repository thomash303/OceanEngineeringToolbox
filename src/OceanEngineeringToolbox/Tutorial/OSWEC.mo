...
model OSWEC
  ...
  inner Environmental.Environment environment(waveHeading = 0, waveSelector = "Regular", frequencySelection = "equalEnergy")  annotation(
    Placement(transformation(origin = {16, 26}, extent = {{-10, -10}, {10, 10}})));
  inner DataImport.FileDirectory fileDirectory(hydroCoeffFile = "/applications/Validation/OSWEC/OSWECHydroCoeff.mat")  annotation(
  ...
  Environmental.Measurement.waveBuoy waveBuoy annotation(
