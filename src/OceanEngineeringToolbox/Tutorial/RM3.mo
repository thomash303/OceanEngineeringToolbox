...
model RM3
  ...
  inner Environmental.Environment environment(redeclare IrregularWave wave(file = fileDirectory.file, waveSpectrum = "PiersonMoskowitz") "Irregular wave")   annotation(
    Placement(transformation(origin = {-42, 52}, extent = {{-12, -12}, {12, 12}})));
  inner DataImport.FileDirectory fileDirectory(file = "C:/Users/thogan1/Documents/GitHub/OceanEngineeringToolbox/applications/Validation/RM3/RM3v1hydroCoeff.mat")  annotation(
    Placement(transformation(origin = {4, 52}, extent = {{-12, -12}, {12, 12}})));
