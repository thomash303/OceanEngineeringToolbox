...
model F3OF_DT2 "Tutorial model for representing the F-3OF decay test 1 in the WEC3 comparison project"
  ...
  Multibody.Joints.Planar planar(phi(start = 0.17453292519943295, fixed = true, displayUnit = "deg")) annotation(
...
equation
  ...
  connect(fixedTranslation.frame_b, planar.frame_a) annotation(
    Line(points = {{-20, -66}, {4, -66}, {4, -62}}, color = {95, 95, 95}));
  connect(planar.frame_b, base.frame_c) annotation(
    Line(points = {{4, -42}, {4, -20}}, color = {95, 95, 95}));
  annotation(
