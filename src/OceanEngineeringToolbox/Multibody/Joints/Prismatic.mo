...
model Prismatic
  "Prismatic joint (1 translational degree-of-freedom, 2 potential states, optional axis flange). Code directly imported from the MSL in the case that there are issues importing Modelica MBS models."
...
protected
  ...
  Interfaces.InternalSupport internalAxis(f = f)
    annotation (Placement(transformation(extent={{70,50},{90,30}})));
  Sources.ConstantForce constantForce(f_constant=0) if not useAxisFlange
