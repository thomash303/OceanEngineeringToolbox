...
model FreeMotion
  "Free motion joint (6 degrees-of-freedom, 12 potential states). Code directly imported from the MSL in the case that there are issues importing Modelica MBS models."
