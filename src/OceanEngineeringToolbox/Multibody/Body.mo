...
model Body
  ...
  // Mass
  parameter SI.Mass M[1,1] annotation(HideResult = true);
  ...
  parameter SI.Length ra_CM[3] = {0, 0, 0} "Position vector between joint A and the centre of mass" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Length rCM_b[3] = {0, 0, 0} "Position vector between the centre of mass and joint B" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Length ra_b[3] = ra_CM + rCM_b "Position vector between joint A and joint B" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_11 = 0.001 "Element (1,1) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_22 = 0.001 "Element (2,2) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_33 = 0.001 "Element (3,3) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_21 = 0 "Element (2,1) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_31 = 0 "Element (3,1) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  parameter SI.Inertia I_32 = 0 "Element (3,2) of inertia tensor" annotation(HideResult = true,
    Dialog(group = "Mass"));
  Parts.FixedTranslation fixedTranslation(r = ra_CM, animation = false) annotation(HideResult = true,
    Placement(transformation(origin = {-50, 0}, extent = {{-10, -10}, {10, 10}})));
  Parts.FixedTranslation fixedTranslation1(r = rCM_b, animation = false) annotation(HideResult = true,
    Placement(transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}})));
  Visualizers.FixedShape fixedShape(length = 1, width = 1, height = 1, animation = animationEnable, shapeType = geometryFile, color = bodyColour) annotation(HideResult = true,
