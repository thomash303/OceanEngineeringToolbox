%% Ocean Engineering Toolbox - Pre-Processing Module
%{
...
(WEC-Sim/source/Functions/readH5ToStruct.m) file. The user must specify the
...
%
%   BEMIO output:          '___.h5'
%   Output structure:      'deviceName_hydroCoeff.mat'


%% Importing BEM Data
% File directory
basePath = 'C:\Users...';        % Path to current folder
fileName = '*.h5';               % Wildcard to select available '.h5' file
filePath = fullfile(basePath, fileName);
%filename = 'C:\Users\thogan1\Documents\GitHub\OceanEngineeringToolbox\RM3\hydroData\rm3.h5';

% Note: Specify output file name at the bottom of the script
...
save('deviceName_hydroCoeff.mat','hydro')
