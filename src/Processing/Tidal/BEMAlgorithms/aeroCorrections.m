classdef aeroCorrections < handle
    ...
    methods
        ...
        function obj = aeroCorrections(prandtlCorrection, prandtlTipLoss,  prandtlHubLoss, glauertCorrection, dynamicStall, dynamicWake, skewedWake, ac, airfoilFile, linThresh, wind, rot, turb)
