...
static void inerter_test3_eqFunction_855(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[77] /* body.z_a[3] variable */).attribute .start = (data->simulationInfo->realParameter[60] /* body.z_0_start[3] PARAM */);
    (data->localData[0]->realVars[77] /* body.z_a[3] variable */) = (data->modelData->realVarsData[77] /* body.z_a[3] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[77].info /* body.z_a[3] */.name, (modelica_real) (data->localData[0]->realVars[77] /* body.z_a[3] variable */));
  TRACE_POP
}
...
static void inerter_test3_eqFunction_856(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[76] /* body.z_a[2] variable */).attribute .start = (data->simulationInfo->realParameter[59] /* body.z_0_start[2] PARAM */);
    (data->localData[0]->realVars[76] /* body.z_a[2] variable */) = (data->modelData->realVarsData[76] /* body.z_a[2] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[76].info /* body.z_a[2] */.name, (modelica_real) (data->localData[0]->realVars[76] /* body.z_a[2] variable */));
  TRACE_POP
}
...
static void inerter_test3_eqFunction_857(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[75] /* body.z_a[1] variable */).attribute .start = (data->simulationInfo->realParameter[58] /* body.z_0_start[1] PARAM */);
    (data->localData[0]->realVars[75] /* body.z_a[1] variable */) = (data->modelData->realVarsData[75] /* body.z_a[1] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[75].info /* body.z_a[1] */.name, (modelica_real) (data->localData[0]->realVars[75] /* body.z_a[1] variable */));
  TRACE_POP
}
...
static void inerter_test3_eqFunction_858(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[74] /* body.w_a[3] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[57] /* body.w_0_start[3] PARAM */);
    (data->localData[0]->realVars[74] /* body.w_a[3] DUMMY_STATE */) = (data->modelData->realVarsData[74] /* body.w_a[3] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[74].info /* body.w_a[3] */.name, (modelica_real) (data->localData[0]->realVars[74] /* body.w_a[3] DUMMY_STATE */));
  TRACE_POP
}
...
static void inerter_test3_eqFunction_859(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[73] /* body.w_a[2] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[56] /* body.w_0_start[2] PARAM */);
    (data->localData[0]->realVars[73] /* body.w_a[2] DUMMY_STATE */) = (data->modelData->realVarsData[73] /* body.w_a[2] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[73].info /* body.w_a[2] */.name, (modelica_real) (data->localData[0]->realVars[73] /* body.w_a[2] DUMMY_STATE */));
  TRACE_POP
}
...
static void inerter_test3_eqFunction_860(DATA *data, threadData_t *threadData)
{
  ...
  (data->modelData->realVarsData[72] /* body.w_a[1] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[55] /* body.w_0_start[1] PARAM */);
    (data->localData[0]->realVars[72] /* body.w_a[1] DUMMY_STATE */) = (data->modelData->realVarsData[72] /* body.w_a[1] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[72].info /* body.w_a[1] */.name, (modelica_real) (data->localData[0]->realVars[72] /* body.w_a[1] DUMMY_STATE */));
  TRACE_POP
}
/*
equation index: 861
...
static void inerter_test3_eqFunction_861(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->realVarsData[288].attribute /* springDamper.s_rel */.nominal = (data->simulationInfo->realParameter[234] /* springDamper.s_nominal PARAM */);
  infoStreamPrint(LOG_INIT_V, 0, "%s(nominal=%g)", data->modelData->realVarsData[288].info /* springDamper.s_rel */.name,
        (modelica_real) data->modelData->realVarsData[288].attribute /* springDamper.s_rel */.nominal);
  TRACE_POP
}
...
int inerter_test3_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  (data->localData[0]->realVars[191] /* cutForce.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[191].time_unvarying = 1;
  (data->localData[0]->realVars[192] /* cutForce.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[192].time_unvarying = 1;
  (data->localData[0]->realVars[193] /* cutForce.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[193].time_unvarying = 1;
  (data->localData[0]->realVars[197] /* cutForce.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[197].time_unvarying = 1;
  (data->localData[0]->realVars[198] /* cutForce.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[198].time_unvarying = 1;
  (data->localData[0]->realVars[199] /* cutForce.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  data->modelData->realVarsData[199].time_unvarying = 1;
  (data->localData[0]->realVars[236] /* force.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[236].time_unvarying = 1;
  (data->localData[0]->realVars[237] /* force.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[237].time_unvarying = 1;
  (data->localData[0]->realVars[238] /* force.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[238].time_unvarying = 1;
  (data->localData[0]->realVars[242] /* force.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[242].time_unvarying = 1;
  (data->localData[0]->realVars[243] /* force.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[243].time_unvarying = 1;
  (data->localData[0]->realVars[244] /* force.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  data->modelData->realVarsData[244].time_unvarying = 1;
