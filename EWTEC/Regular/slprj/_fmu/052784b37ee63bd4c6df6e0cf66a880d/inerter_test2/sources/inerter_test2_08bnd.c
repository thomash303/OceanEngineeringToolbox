...
*/
static void inerter_test2_eqFunction_1110(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1110};
  (data->modelData->realVarsData[416] /* body.z_a[1] variable */).attribute .start = (data->simulationInfo->realParameter[62] /* body.z_0_start[1] PARAM */);
    (data->localData[0]->realVars[416] /* body.z_a[1] variable */) = (data->modelData->realVarsData[416] /* body.z_a[1] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[416].info /* body.z_a[1] */.name, (modelica_real) (data->localData[0]->realVars[416] /* body.z_a[1] variable */));
  TRACE_POP
}
...
*/
static void inerter_test2_eqFunction_1109(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1109};
  (data->modelData->realVarsData[417] /* body.z_a[2] variable */).attribute .start = (data->simulationInfo->realParameter[63] /* body.z_0_start[2] PARAM */);
    (data->localData[0]->realVars[417] /* body.z_a[2] variable */) = (data->modelData->realVarsData[417] /* body.z_a[2] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[417].info /* body.z_a[2] */.name, (modelica_real) (data->localData[0]->realVars[417] /* body.z_a[2] variable */));
  TRACE_POP
}
...
*/
static void inerter_test2_eqFunction_1108(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1108};
  (data->modelData->realVarsData[418] /* body.z_a[3] variable */).attribute .start = (data->simulationInfo->realParameter[64] /* body.z_0_start[3] PARAM */);
    (data->localData[0]->realVars[418] /* body.z_a[3] variable */) = (data->modelData->realVarsData[418] /* body.z_a[3] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[418].info /* body.z_a[3] */.name, (modelica_real) (data->localData[0]->realVars[418] /* body.z_a[3] variable */));
  TRACE_POP
}
...
*/
static void inerter_test2_eqFunction_1107(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1107};
  (data->modelData->realVarsData[413] /* body.w_a[1] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[59] /* body.w_0_start[1] PARAM */);
    (data->localData[0]->realVars[413] /* body.w_a[1] DUMMY_STATE */) = (data->modelData->realVarsData[413] /* body.w_a[1] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[413].info /* body.w_a[1] */.name, (modelica_real) (data->localData[0]->realVars[413] /* body.w_a[1] DUMMY_STATE */));
  TRACE_POP
}
...
*/
static void inerter_test2_eqFunction_1106(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1106};
  (data->modelData->realVarsData[414] /* body.w_a[2] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[60] /* body.w_0_start[2] PARAM */);
    (data->localData[0]->realVars[414] /* body.w_a[2] DUMMY_STATE */) = (data->modelData->realVarsData[414] /* body.w_a[2] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[414].info /* body.w_a[2] */.name, (modelica_real) (data->localData[0]->realVars[414] /* body.w_a[2] DUMMY_STATE */));
  TRACE_POP
}
...
*/
static void inerter_test2_eqFunction_1105(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1105};
  (data->modelData->realVarsData[415] /* body.w_a[3] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[61] /* body.w_0_start[3] PARAM */);
    (data->localData[0]->realVars[415] /* body.w_a[3] DUMMY_STATE */) = (data->modelData->realVarsData[415] /* body.w_a[3] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[415].info /* body.w_a[3] */.name, (modelica_real) (data->localData[0]->realVars[415] /* body.w_a[3] DUMMY_STATE */));
  TRACE_POP
}
/*
equation index: 1111
...
*/
static void inerter_test2_eqFunction_1111(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1111};
  data->modelData->realVarsData[570].attribute /* springDamper.s_rel */.nominal = (data->simulationInfo->realParameter[233] /* springDamper.s_nominal PARAM */);
  infoStreamPrint(LOG_INIT_V, 0, "%s(nominal=%g)", data->modelData->realVarsData[570].info /* springDamper.s_rel */.name,
        (modelica_real) data->modelData->realVarsData[570].attribute /* springDamper.s_rel */.nominal);
  TRACE_POP
}
...
int inerter_test2_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  (data->localData[0]->integerVars[16] /* prismatic.boxColor[2] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[16].time_unvarying = 1;
  (data->localData[0]->integerVars[17] /* prismatic.boxColor[3] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[17].time_unvarying = 1;
  (data->localData[0]->integerVars[19] /* revolute.cylinderColor[2] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[19].time_unvarying = 1;
  (data->localData[0]->integerVars[20] /* revolute.cylinderColor[3] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[20].time_unvarying = 1;
  (data->localData[0]->integerVars[21] /* world.axisColor_x[1] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[21].time_unvarying = 1;
  (data->localData[0]->integerVars[22] /* world.axisColor_x[2] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[22].time_unvarying = 1;
  (data->localData[0]->integerVars[23] /* world.axisColor_x[3] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[23].time_unvarying = 1;
  (data->localData[0]->integerVars[24] /* world.gravityArrowColor[1] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[24].time_unvarying = 1;
  (data->localData[0]->integerVars[26] /* world.gravityArrowColor[3] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[26].time_unvarying = 1;
  (data->localData[0]->integerVars[27] /* world.gravitySphereColor[1] DISCRETE */) = ((modelica_integer) 0);
  data->modelData->integerVarsData[27].time_unvarying = 1;
  (data->localData[0]->integerVars[29] /* world.gravitySphereColor[3] DISCRETE */) = ((modelica_integer) 0);
  ...
  (data->simulationInfo->integerParameter[47] /* world.ndim PARAM */) = ((modelica_integer) 1);
  data->modelData->integerParameterData[47].time_unvarying = 1;
  (data->simulationInfo->integerParameter[48] /* world.ndim2 PARAM */) = ((modelica_integer) 1);
  data->modelData->integerParameterData[48].time_unvarying = 1;
  (data->simulationInfo->integerParameter[49] /* world.ndim_pointGravity PARAM */) = ((modelica_integer) 0);
  data->modelData->integerParameterData[49].time_unvarying = 1;
  (data->simulationInfo->integerParameter[50] /* world.x_label.n PARAM */) = ((modelica_integer) 2);
  data->modelData->integerParameterData[50].time_unvarying = 1;
  (data->simulationInfo->integerParameter[51] /* world.y_label.n PARAM */) = ((modelica_integer) 2);
  data->modelData->integerParameterData[51].time_unvarying = 1;
  (data->simulationInfo->integerParameter[52] /* world.z_label.n PARAM */) = ((modelica_integer) 3);
  ...
  (data->localData[0]->realVars[228] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[228].time_unvarying = 1;
  (data->localData[0]->realVars[229] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[229].time_unvarying = 1;
  (data->localData[0]->realVars[230] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[230].time_unvarying = 1;
  (data->localData[0]->realVars[234] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[234].time_unvarying = 1;
  (data->localData[0]->realVars[235] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[235].time_unvarying = 1;
  (data->localData[0]->realVars[236] /* SprungMassCase3.transformVector_a.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  data->modelData->realVarsData[236].time_unvarying = 1;
  (data->localData[0]->realVars[294] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[294].time_unvarying = 1;
  (data->localData[0]->realVars[295] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[295].time_unvarying = 1;
  (data->localData[0]->realVars[296] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[296].time_unvarying = 1;
  (data->localData[0]->realVars[300] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[300].time_unvarying = 1;
  (data->localData[0]->realVars[301] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[301].time_unvarying = 1;
  (data->localData[0]->realVars[302] /* SprungMassCase3.velocity.transformAbsoluteVector.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  data->modelData->realVarsData[302].time_unvarying = 1;
  (data->localData[0]->realVars[315] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[315].time_unvarying = 1;
  (data->localData[0]->realVars[316] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[316].time_unvarying = 1;
  (data->localData[0]->realVars[317] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[317].time_unvarying = 1;
  (data->localData[0]->realVars[321] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[321].time_unvarying = 1;
  (data->localData[0]->realVars[322] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[322].time_unvarying = 1;
  (data->localData[0]->realVars[323] /* SprungMassCase3.velocity.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  ...
  (data->simulationInfo->realParameter[58] /* body.sphereDiameter PARAM */) = 0.2;
  ...
  (data->simulationInfo->realParameter[182] /* idealGearR2T.fixedR.phi0 PARAM */) = 0.0;
  data->modelData->realParameterData[182].time_unvarying = 1;
  (data->simulationInfo->realParameter[184] /* idealGearR2T.fixedT.s0 PARAM */) = 0.0;
  data->modelData->realParameterData[184].time_unvarying = 1;
  (data->simulationInfo->realParameter[198] /* prismatic.boxWidthDirection[1] PARAM */) = 0.0;
  data->modelData->realParameterData[198].time_unvarying = 1;
  (data->simulationInfo->realParameter[199] /* prismatic.boxWidthDirection[2] PARAM */) = 1.0;
  data->modelData->realParameterData[199].time_unvarying = 1;
  (data->simulationInfo->realParameter[200] /* prismatic.boxWidthDirection[3] PARAM */) = 0.0;
  data->modelData->realParameterData[200].time_unvarying = 1;
  (data->simulationInfo->realParameter[201] /* prismatic.e[1] PARAM */) = 0.0;
  data->modelData->realParameterData[201].time_unvarying = 1;
  (data->simulationInfo->realParameter[202] /* prismatic.e[2] PARAM */) = 1.0;
  data->modelData->realParameterData[202].time_unvarying = 1;
  (data->simulationInfo->realParameter[203] /* prismatic.e[3] PARAM */) = 0.0;
  data->modelData->realParameterData[203].time_unvarying = 1;
  (data->simulationInfo->realParameter[205] /* prismatic.fixed.s0 PARAM */) = 0.0;
  data->modelData->realParameterData[205].time_unvarying = 1;
  (data->simulationInfo->realParameter[206] /* prismatic.n[1] PARAM */) = 0.0;
  data->modelData->realParameterData[206].time_unvarying = 1;
  (data->simulationInfo->realParameter[207] /* prismatic.n[2] PARAM */) = 1.0;
  data->modelData->realParameterData[207].time_unvarying = 1;
  (data->simulationInfo->realParameter[208] /* prismatic.n[3] PARAM */) = 0.0;
  data->modelData->realParameterData[208].time_unvarying = 1;
  (data->simulationInfo->realParameter[220] /* revolute.e[1] PARAM */) = 0.0;
  data->modelData->realParameterData[220].time_unvarying = 1;
  (data->simulationInfo->realParameter[221] /* revolute.e[2] PARAM */) = 1.0;
  data->modelData->realParameterData[221].time_unvarying = 1;
  (data->simulationInfo->realParameter[222] /* revolute.e[3] PARAM */) = 0.0;
  data->modelData->realParameterData[222].time_unvarying = 1;
  (data->simulationInfo->realParameter[224] /* revolute.fixed.phi0 PARAM */) = 0.0;
  data->modelData->realParameterData[224].time_unvarying = 1;
  (data->simulationInfo->realParameter[225] /* revolute.n[1] PARAM */) = 0.0;
  data->modelData->realParameterData[225].time_unvarying = 1;
  (data->simulationInfo->realParameter[226] /* revolute.n[2] PARAM */) = 1.0;
  data->modelData->realParameterData[226].time_unvarying = 1;
  (data->simulationInfo->realParameter[227] /* revolute.n[3] PARAM */) = 0.0;
  data->modelData->realParameterData[227].time_unvarying = 1;
  (data->simulationInfo->realParameter[239] /* world.defaultBodyDiameter PARAM */) = 0.1111111111111111;
  data->modelData->realParameterData[239].time_unvarying = 1;
  (data->simulationInfo->realParameter[270] /* world.n[1] PARAM */) = 0.0;
  data->modelData->realParameterData[270].time_unvarying = 1;
  (data->simulationInfo->realParameter[271] /* world.n[2] PARAM */) = -1.0;
  data->modelData->realParameterData[271].time_unvarying = 1;
  (data->simulationInfo->realParameter[272] /* world.n[3] PARAM */) = 0.0;
  data->modelData->realParameterData[272].time_unvarying = 1;
  (data->simulationInfo->realParameter[273] /* world.nominalLength PARAM */) = 1.0;
  ...
  (data->simulationInfo->booleanParameter[27] /* idealGearR2T.useSupportR PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[27].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[28] /* idealGearR2T.useSupportT PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[28].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[29] /* positionToForceAdaptor.use_fder PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[29].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[30] /* positionToForceAdaptor.use_fder2 PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[30].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[31] /* positionToForceAdaptor.use_pder PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[31].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[32] /* positionToForceAdaptor.use_pder2 PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[32].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[33] /* prismatic.animation PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[33].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[34] /* prismatic.useAxisFlange PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[34].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[35] /* revolute.animation PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[35].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[36] /* revolute.useAxisFlange PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[36].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[37] /* springDamper.useHeatPort PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[37].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[38] /* world.animateGravity PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[38].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[39] /* world.animateGround PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[39].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[40] /* world.animateWorld PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[40].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[41] /* world.axisShowLabels PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[41].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[43] /* world.enableAnimation PARAM */) = 1 /* true */;
  ...
  (data->simulationInfo->integerParameter[42] /* inertia.stateSelect PARAM */) = 3;
  data->modelData->integerParameterData[42].time_unvarying = 1;
  (data->simulationInfo->integerParameter[43] /* prismatic.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[43].time_unvarying = 1;
  (data->simulationInfo->integerParameter[44] /* revolute.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[44].time_unvarying = 1;
  (data->simulationInfo->integerParameter[45] /* springDamper.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[45].time_unvarying = 1;
  (data->simulationInfo->integerParameter[46] /* world.gravityType PARAM */) = 1;
