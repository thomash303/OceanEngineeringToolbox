...
void inerter_test2_function_initSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
/* Update base-clock. */
void inerter_test2_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
  TRACE_PUSH
...
int inerter_test2_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  TRACE_PUSH
  int ret;
...
/* %v% = pre(%v%)*/
void inerter_test2_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
