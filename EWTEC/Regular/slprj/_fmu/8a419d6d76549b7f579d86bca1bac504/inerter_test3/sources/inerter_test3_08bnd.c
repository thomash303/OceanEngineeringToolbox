...
*/
static void inerter_test3_eqFunction_786(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,786};
  (data->modelData->realVarsData[79] /* body.z_a[3] variable */).attribute .start = (data->simulationInfo->realParameter[60] /* body.z_0_start[3] PARAM */);
    (data->localData[0]->realVars[79] /* body.z_a[3] variable */) = (data->modelData->realVarsData[79] /* body.z_a[3] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[79].info /* body.z_a[3] */.name, (modelica_real) (data->localData[0]->realVars[79] /* body.z_a[3] variable */));
  TRACE_POP
}
...
*/
static void inerter_test3_eqFunction_787(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,787};
  (data->modelData->realVarsData[78] /* body.z_a[2] variable */).attribute .start = (data->simulationInfo->realParameter[59] /* body.z_0_start[2] PARAM */);
    (data->localData[0]->realVars[78] /* body.z_a[2] variable */) = (data->modelData->realVarsData[78] /* body.z_a[2] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[78].info /* body.z_a[2] */.name, (modelica_real) (data->localData[0]->realVars[78] /* body.z_a[2] variable */));
  TRACE_POP
}
...
*/
static void inerter_test3_eqFunction_788(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,788};
  (data->modelData->realVarsData[77] /* body.z_a[1] variable */).attribute .start = (data->simulationInfo->realParameter[58] /* body.z_0_start[1] PARAM */);
    (data->localData[0]->realVars[77] /* body.z_a[1] variable */) = (data->modelData->realVarsData[77] /* body.z_a[1] variable */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[77].info /* body.z_a[1] */.name, (modelica_real) (data->localData[0]->realVars[77] /* body.z_a[1] variable */));
  TRACE_POP
}
...
*/
static void inerter_test3_eqFunction_789(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,789};
  (data->modelData->realVarsData[76] /* body.w_a[3] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[57] /* body.w_0_start[3] PARAM */);
    (data->localData[0]->realVars[76] /* body.w_a[3] DUMMY_STATE */) = (data->modelData->realVarsData[76] /* body.w_a[3] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[76].info /* body.w_a[3] */.name, (modelica_real) (data->localData[0]->realVars[76] /* body.w_a[3] DUMMY_STATE */));
  TRACE_POP
}
...
*/
static void inerter_test3_eqFunction_790(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,790};
  (data->modelData->realVarsData[75] /* body.w_a[2] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[56] /* body.w_0_start[2] PARAM */);
    (data->localData[0]->realVars[75] /* body.w_a[2] DUMMY_STATE */) = (data->modelData->realVarsData[75] /* body.w_a[2] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[75].info /* body.w_a[2] */.name, (modelica_real) (data->localData[0]->realVars[75] /* body.w_a[2] DUMMY_STATE */));
  TRACE_POP
}
...
*/
static void inerter_test3_eqFunction_791(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,791};
  (data->modelData->realVarsData[74] /* body.w_a[1] DUMMY_STATE */).attribute .start = (data->simulationInfo->realParameter[55] /* body.w_0_start[1] PARAM */);
    (data->localData[0]->realVars[74] /* body.w_a[1] DUMMY_STATE */) = (data->modelData->realVarsData[74] /* body.w_a[1] DUMMY_STATE */).attribute .start;
    infoStreamPrint(LOG_INIT_V, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[74].info /* body.w_a[1] */.name, (modelica_real) (data->localData[0]->realVars[74] /* body.w_a[1] DUMMY_STATE */));
  TRACE_POP
}
/*
equation index: 792
...
*/
static void inerter_test3_eqFunction_792(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,792};
  data->modelData->realVarsData[251].attribute /* springDamper.s_rel */.nominal = (data->simulationInfo->realParameter[235] /* springDamper.s_nominal PARAM */);
  infoStreamPrint(LOG_INIT_V, 0, "%s(nominal=%g)", data->modelData->realVarsData[251].info /* springDamper.s_rel */.name,
        (modelica_real) data->modelData->realVarsData[251].attribute /* springDamper.s_rel */.nominal);
  TRACE_POP
}
...
int inerter_test3_updateBoundVariableAttributes(DATA *data, threadData_t *threadData)
{
  ...
  inerter_test3_eqFunction_786(data, threadData);

  inerter_test3_eqFunction_787(data, threadData);
...
int inerter_test3_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  (data->simulationInfo->integerParameter[27] /* world.ndim PARAM */) = ((modelica_integer) 1);
  data->modelData->integerParameterData[27].time_unvarying = 1;
  (data->simulationInfo->integerParameter[28] /* world.ndim2 PARAM */) = ((modelica_integer) 1);
  data->modelData->integerParameterData[28].time_unvarying = 1;
  (data->simulationInfo->integerParameter[29] /* world.ndim_pointGravity PARAM */) = ((modelica_integer) 0);
  data->modelData->integerParameterData[29].time_unvarying = 1;
  (data->simulationInfo->integerParameter[30] /* world.x_label.n PARAM */) = ((modelica_integer) 2);
  data->modelData->integerParameterData[30].time_unvarying = 1;
  (data->simulationInfo->integerParameter[31] /* world.y_label.n PARAM */) = ((modelica_integer) 2);
  data->modelData->integerParameterData[31].time_unvarying = 1;
  (data->simulationInfo->integerParameter[32] /* world.z_label.n PARAM */) = ((modelica_integer) 3);
  data->modelData->integerParameterData[32].time_unvarying = 1;
  (data->localData[0]->realVars[192] /* cutForce.zeroPosition.frame_resolve.f[1] variable */) = -0.0;
  data->modelData->realVarsData[192].time_unvarying = 1;
  (data->localData[0]->realVars[193] /* cutForce.zeroPosition.frame_resolve.f[2] variable */) = -0.0;
  data->modelData->realVarsData[193].time_unvarying = 1;
  (data->localData[0]->realVars[194] /* cutForce.zeroPosition.frame_resolve.f[3] variable */) = -0.0;
  data->modelData->realVarsData[194].time_unvarying = 1;
  (data->localData[0]->realVars[198] /* cutForce.zeroPosition.frame_resolve.t[1] variable */) = -0.0;
  data->modelData->realVarsData[198].time_unvarying = 1;
  (data->localData[0]->realVars[199] /* cutForce.zeroPosition.frame_resolve.t[2] variable */) = -0.0;
  data->modelData->realVarsData[199].time_unvarying = 1;
  (data->localData[0]->realVars[200] /* cutForce.zeroPosition.frame_resolve.t[3] variable */) = -0.0;
  ...
  (data->simulationInfo->realParameter[181] /* idealGearR2T.fixedR.phi0 PARAM */) = 0.0;
  data->modelData->realParameterData[181].time_unvarying = 1;
  (data->simulationInfo->realParameter[183] /* idealGearR2T.fixedT.s0 PARAM */) = 0.0;
  ...
  (data->simulationInfo->booleanParameter[23] /* idealGearR2T.useSupportR PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[23].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[24] /* idealGearR2T.useSupportT PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[24].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[25] /* position.exact PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[25].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[26] /* position.useSupport PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[26].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[27] /* prismatic.animation PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[27].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[28] /* prismatic.useAxisFlange PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[28].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[29] /* revolute.animation PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[29].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[30] /* revolute.useAxisFlange PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[30].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[31] /* springDamper.useHeatPort PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[31].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[32] /* world.animateGravity PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[32].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[33] /* world.animateGround PARAM */) = 0 /* false */;
  data->modelData->booleanParameterData[33].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[34] /* world.animateWorld PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[34].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[35] /* world.axisShowLabels PARAM */) = 1 /* true */;
  data->modelData->booleanParameterData[35].time_unvarying = 1;
  (data->simulationInfo->booleanParameter[37] /* world.enableAnimation PARAM */) = 1 /* true */;
  ...
  (data->simulationInfo->integerParameter[23] /* prismatic.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[23].time_unvarying = 1;
  (data->simulationInfo->integerParameter[24] /* revolute.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[24].time_unvarying = 1;
  (data->simulationInfo->integerParameter[25] /* springDamper.stateSelect PARAM */) = 4;
  data->modelData->integerParameterData[25].time_unvarying = 1;
  (data->simulationInfo->integerParameter[26] /* world.gravityType PARAM */) = 1;
