...
plot(body(1).time(1:2000), body(1).velocity(1:2000,5), 'LineWidth', LineWidth, 'Color' ...
    ,blue);
hold on;
plot(output.bodies(1).time(1:2000), output.bodies(1).velocity(1:2000,5), 'LineWidth', LineWidth, 'Color' ...
    ,orange);
